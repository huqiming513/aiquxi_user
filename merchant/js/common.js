window.base={
 g_restUrl:'https://www.aiquxi.net/aiquxi/public/index.php/',
    ...
    getData:function(params){
       // window.base.setLocalStorage("token","d2c8ac3b15984b3e43d8ecc2f87763ce")
        ...
        $.ajax({
            ...
            beforeSend: function (XMLHttpRequest) {
                ...
                if (params.tokenFlag) {
                    XMLHttpRequest.setRequestHeader('token', that.getLocalStorage('mertoken'));
                 //   XMLHttpRequest.setRequestHeader('token', 'd2c8ac3b15984b3e43d8ecc2f87763ce');
